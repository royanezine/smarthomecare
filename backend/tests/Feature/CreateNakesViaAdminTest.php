...
class CreateNakesViaAdminTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Pastikan tabel master_provinsi/wilayah punya dummy data
        DB::table('master_provinsi')->insert([
            'id_provinsi' => 1,
            'nama_provinsi' => 'DKI Jakarta'
        ]);

        // Pastikan role 'nakes' ada di tabel user_roles / roles
    ...
    public function test_admin_can_create_nakes_with_new_user_and_approved_status()
    {
        ...
        $this->assertTrue($createdUser->roles()->where('user_roles.nama_role', 'nakes')->exists());
